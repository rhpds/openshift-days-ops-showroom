...
*Generate AgV catalog description:*
[source,text]
----
...
=== AgnosticV Catalog Description Generator

*What it does*: Creates properly formatted `description.adoc` files for AgnosticV catalog entries that appear in the Red Hat Demo Platform UI.
...
* Complete `description.adoc` file with:
** Brief overview (2-3 sentences)
** Warning blocks (if needed)
** Link to rendered Showroom guide (GitHub Pages URL)
** Featured technology list
** Detailed agenda (auto-generated from modules)
** Author contact information

*Smart features*:

* Auto-detects Showroom content (asks for path)
* Extracts module structure and technologies
* Auto-detects GitHub Pages URL from git remote
...
* `generate-agv-description/SKILL.md` - AgV catalog description generator
...
*Ready to create content!* Just say "create lab", "create demo", or "generate agv description" in Cursor chat.
