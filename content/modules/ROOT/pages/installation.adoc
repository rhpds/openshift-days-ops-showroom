...
The best way to verify monitoring is working is to actually use it. In the **OCP Console**, navigate to **Observe -> Dashboards** and select any dashboard (try **etcd** or **Kubernetes / Compute Resources / Cluster**). If the dashboards load with real data and graphs, monitoring is fully operational.
