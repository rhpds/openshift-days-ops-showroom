...
OpenShift runs on virtually any infrastructure—public clouds, private clouds, or bare metal. This module explains how OpenShift abstracts cloud provider APIs so you can manage infrastructure using the same `oc` commands regardless of where you deploy.
