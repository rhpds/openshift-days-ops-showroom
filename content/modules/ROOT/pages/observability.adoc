...
Install all three logging operators (Loki, Cluster Logging, Cluster Observability):
...
Wait about 90 seconds for the operators to install, then verify all three are ready:
