...
NOTE: This is already enabled on your workshop cluster — you don't need to do anything. On a new cluster, you would enable it by setting `enableUserWorkload: true` in the `cluster-monitoring-config` ConfigMap in the `openshift-monitoring` namespace.
