...
Switch to the **Alerts** tab (not Alerting Rules). Filter by state — you'll see alerts that are currently **Firing**, **Pending**, or **Silenced**. If any pods in the cluster are restart-looping, your new `HighPodRestartRate` rule will appear here. This is the view on-call engineers live in — knowing how to read it matters more than knowing how to create rules.
