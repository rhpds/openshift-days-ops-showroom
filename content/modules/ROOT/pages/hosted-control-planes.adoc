...
----
kube-apiserver-xxx   4/4   Running   0   3m   10.131.0.211   ip-10-0-26-88.us-east-2.compute.internal
----
...
clusters-demo-hcp     data-etcd-0    Bound    pvc-xxxxx    8Gi        ocs-storagecluster-ceph-rbd
----
...
You'll see a LoadBalancer IP (provided by MetalLB):

----
server: https://10.10.10.203:6443
----

**This is the hosted cluster's API server**, accessible via MetalLB LoadBalancer!
...
----
Kubernetes control plane is running at https://10.10.10.203:6443
----
