...
image::diagrams/03_ingress.png[OpenShift Ingress Load Balancer Flow, align=center]

== Ingress Controller & Load Balancing

The **Ingress Controller** (HAProxy by default, though other ingress controllers can be used) handles all external traffic entering the cluster.
