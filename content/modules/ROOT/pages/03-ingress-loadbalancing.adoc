...
image::ingress-images/ingress-weathernow-route.png[Test app route in the console]
...
You should see HTML returned from the web server (the default Apache test page).
