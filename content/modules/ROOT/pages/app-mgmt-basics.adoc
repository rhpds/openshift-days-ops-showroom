...
You should see one pod in `Running` status. You can also see your pod in the **OCP Console** at **Workloads -> Pods** (project: `app-management`). Click the pod name to see details, logs, events, and resource usage — all in one view.
