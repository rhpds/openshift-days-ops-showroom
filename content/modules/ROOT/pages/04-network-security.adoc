...
TIP: You can also view this in the console at **Administration → Cluster Settings → Configuration**, search for "Network" and select **Network** (`config.openshift.io`) for a formatted view of cluster and service network CIDRs.
...
image::diagrams/04_egress_ip.png[OpenShift EgressIP Architecture, align=center]
