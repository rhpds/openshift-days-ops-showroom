...
For more details, see link:https://docs.redhat.com/en/documentation/red_hat_openshift_gitops/1.21/html/understanding_openshift_gitops/index[Understanding OpenShift GitOps, window=blank].
...
For more information, see link:https://docs.redhat.com/en/documentation/red_hat_openshift_gitops/1.21/html/understanding_openshift_gitops/index[Understanding OpenShift GitOps, window=blank].
