...
master-0   Ready    control-plane,master   91m   v1.33.5
master-1   Ready    control-plane,master   91m   v1.33.5
master-2   Ready    control-plane,master   89m   v1.33.5
worker-0   Ready    worker                 84m   v1.33.5
worker-1   Ready    worker                 83m   v1.33.5
----

NOTE: Node names vary by platform. Cloud platforms use internal DNS names, bare metal uses hostnames you define.
