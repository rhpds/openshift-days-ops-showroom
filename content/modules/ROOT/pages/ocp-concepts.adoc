...
In vanilla Kubernetes, you'd SSH to the node and run `top`, `df`, and `crictl pods`. In OpenShift, active alerts, utilization graphs, and per-pod resource usage are all in one console view — no SSH required.
