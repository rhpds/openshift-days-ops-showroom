...
cluster-xxxxx-worker-zone-a      1         1         1       1           104m
cluster-xxxxx-worker-zone-b      1         1         1       1           104m
cluster-xxxxx-worker-zone-c      0         0                             104m
----

This shows:
- **Multiple MachineSets** (typically one per availability zone or failure domain)
- **Active workers** distributed across zones
- **Scaled to 0** - zone is available but not in use

You can also view the actual machine resources:
...
This shows the underlying compute instances that OpenShift is managing for you.
