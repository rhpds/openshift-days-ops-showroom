...
Look at the memory percentages across your nodes. In the **OCP Console**, navigate to **Observe -> Dashboards** and select **Kubernetes / Compute Resources / Namespace (Pods)**, then choose project `performance-demo`. The graphs show how your HPA scaling event looked over time — you can see CPU spike, pods scale up, then stabilize.
