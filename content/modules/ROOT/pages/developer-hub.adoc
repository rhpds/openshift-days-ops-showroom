...
1. In the Developer Hub portal, click **Create** in the left navigation
...
----
+
4. Click **Analyze** — RHDH fetches the YAML and shows you what will be registered
5. Click **Import** to add them to the catalog

Now click **Catalog** in the left navigation. You should see two components: `weather-app` and `backup-demo-app`. Click on either one — you'll see the component overview page showing the owner, lifecycle, and the OpenShift namespace annotation.
