...
This workshop lets you answer those questions hands-on. You'll break things on purpose and fix them, diagnose real failure modes, configure production security, and see what OpenShift looks like when things go wrong (and how fast you can recover).
...
|Verify cluster health, read etcd dashboards, deploy an app and expose it in 30 seconds

|**Application Operations**
|Deploy workloads, break a readiness probe on purpose, scale with HPA under real load, configure network policies
...
image::diagrams/01_platform_architecture.png[OpenShift Platform Architecture, align=center]
...
image::diagrams/01_control_plane.png[Control Plane Responsibilities, 300, align=center]
...
Hundreds. All certified and ready to install.
