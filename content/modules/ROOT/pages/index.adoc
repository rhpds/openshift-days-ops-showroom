...
* Navigate the workshop interface and verify CLI access
* Understand key differences between OpenShift and upstream Kubernetes
* Explore the Administrator Console and built-in monitoring
* See built-in capabilities that come ready to use out of the box
...
image::showroom-tabs.png[Showroom interface showing tabs for OCP Console, Terminal, RHACS, ArgoCD, and Developer Hub]
