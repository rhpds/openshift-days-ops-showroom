...
IMPORTANT: This `oc apply` replaces the entire OAuth spec, including any previously configured identity providers (e.g., HTPasswd from the LDAP module). Only the OIDC provider defined below will be active after applying.
