...
To restore from a snapshot, you would stop the VM and apply a `VirtualMachineRestore` CR:
...
This restores the VM's disks and configuration to the exact state captured in the snapshot.
