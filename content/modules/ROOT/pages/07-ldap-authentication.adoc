...
[source,bash,role="execute"]
----
if curl -fsSL --retry 3 --retry-delay 2 -o /tmp/deploy-glauth-ldap.sh https://raw.githubusercontent.com/rhpds/openshift-days-ops-showroom/dev/support/07-ldap-authentication/deploy-glauth-ldap.sh; then
