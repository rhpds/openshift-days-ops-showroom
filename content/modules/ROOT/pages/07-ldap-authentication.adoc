...
if curl -fsSL --retry 3 --retry-delay 2 -o /tmp/deploy-glauth-ldap.sh {support_base_url}/07-ldap-authentication/deploy-glauth-ldap.sh; then
  ...
  echo "ERROR: Could not download deploy-glauth-ldap.sh. Check your network connection and re-run this command - the Showroom instance may be temporarily unavailable."
fi
----
...
if curl -fsSL --retry 3 --retry-delay 2 -o /tmp/configure-oauth-ldap.sh {support_base_url}/07-ldap-authentication/configure-oauth-ldap.sh; then
  ...
  echo "ERROR: Could not download configure-oauth-ldap.sh. Check your network connection and re-run this command - the Showroom instance may be temporarily unavailable."
fi
----
...
if curl -fsSL --retry 3 --retry-delay 2 -o /tmp/cleanup-ldap.sh {support_base_url}/cleanup-scripts/cleanup-ldap.sh; then
  ...
  echo "ERROR: Could not download cleanup-ldap.sh. Check your network connection and re-run this command - the Showroom instance may be temporarily unavailable."
fi
----
