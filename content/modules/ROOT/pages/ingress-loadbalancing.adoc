...
* Implement network security policies for traffic control
...
On cloud platforms, this creates a cloud load balancer (NLB on AWS, Azure LB, etc.). On bare metal or virtualized environments, MetalLB provides LoadBalancer functionality.
