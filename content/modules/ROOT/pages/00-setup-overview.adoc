...
The tabs across the top give you direct access to each tool — OCP Console, Terminal, RHACS, ArgoCD, and Developer Hub. Switch between them as you work.

TIP: Highlighted command blocks are **clickable** — they switch to the Terminal tab and execute automatically.

== About This Workshop

Every module is hands-on. You'll break things on purpose and fix them, diagnose real failure modes, configure production security, and see what OpenShift looks like when things go wrong.
...
Nobody installed Prometheus on this cluster. It's already running. Let's prove it.
