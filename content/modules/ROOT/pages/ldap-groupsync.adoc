...
If you're locked out, log in with your LDAP admin account:
...
**Production best practice:** Always remove the kubeadmin bootstrap account after configuring enterprise authentication.
