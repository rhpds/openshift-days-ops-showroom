...
NOTE: On this workshop cluster, the kubeadmin secret has already been removed (you'll see "not found"). This is correct — the cluster uses HTPasswd authentication instead. In production, you'd remove kubeadmin after configuring LDAP or OIDC.
