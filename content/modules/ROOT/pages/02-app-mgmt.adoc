...
Before moving on, get familiar with the two most important diagnostic commands. These work on any pod in any namespace. You can also see this information in the console — click the workload node in the Topology view, then click the pod name in the side panel on the right to open the pod detail view with **Details**, **Events**, and **Logs** tabs. The console log viewer supports real-time streaming, text search, and downloading.
