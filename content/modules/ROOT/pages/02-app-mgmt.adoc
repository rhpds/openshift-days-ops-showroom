...
You should see the original WeatherNow image, resolved to the internal registry mirror and pinned to a digest since OpenShift resolves image tags via the ImageStream:

----
image-registry.openshift-image-registry.svc:5000/app-management/weathernow@sha256:362b6db3...
----
