...
NOTE: This module intentionally switches between CLI and Console as you go - each task uses whichever is fastest to demonstrate, the same way an ops engineer would in practice. Deploying here is quicker to show visually in the Console; later steps return to the CLI where it's the more natural tool.
